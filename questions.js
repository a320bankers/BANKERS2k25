...
{
    question: "Select the correct statement about the AGENT pushbuttons on the FIRE panel",
    answers: ["It is not possible to have an amber DISCH light without a white SQUIB light on a AGENT pushbutton", "The agent buttons are always active allowing a bottle to be fired at any time, independent of the associated FIRE pushbutton position", "The DISCH light illuminates in amber as soon as the squib is fired for the corresponding bottle", "The DISCH light illuminates in amber when the corresponding fire extinguisher bottle has lost pressure"],
    correct: 4
},
{
